  ...
  return (
    <div className="home-container">
      ...
      <ul className="feature-list">
        <li className="feature-item">1 - Create a celestial object to update our database with information on a new celestial object -- Subject to Review</li>
        ...
        <li className="feature-item">5 - Go ahead and click on the celestial objects section to view our database of the Cosmos; or on New to create a new celestial object for our database -- Subject to Review </li>
      </ul>
